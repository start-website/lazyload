...
const webpackConfig = {
  ...
  entry: {
    ...
    //'lazysizes.min': './src/js/lazysizes.min.js',
  },
  output: {
    filename: '[name].js',
  },
...
gulp.task('default', gulp.parallel('watch', 'move-dist', 'webpack', 'webp', 'browser-sync'));

gulp.task('build', gulp.series('postcss', 'clean' ,'postcss', 'move-dist', 'move-dist-js', 'move-dist-images', 'tiny', 'webpack', 'webp'));
